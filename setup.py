...
setup(
	...
	install_requires=['absl-py==0.4.0', 'astor==0.7.1', 'bleach==1.5.0', 'click==6.7',
	                  ...
	                  'kiwisolver==1.0.1', 'Markdown==2.6.11', 'MarkupSafe==1.0', 'matplotlib==2.2.2', 'nose==1.3.7', 'numpy==1.17.0',
	                  'pandas==0.24.0', 'protobuf==3.6.0', 'pyparsing==2.2.0', 'python-dateutil==2.7.3', 'pytz==2018.5', 'python-Levenshtein',
	                  'PyYAML==3.13', 'scikit-learn==0.20.0', 'scipy==1.1.0', 'six==1.11.0',
	                  'sklearn==0.0', 'tensorflow==1.15', 'termcolor==1.1.0',
