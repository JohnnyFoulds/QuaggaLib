...
setup(
	...
	install_requires=['absl-py==0.7.0', 'astor==0.7.1', 'bleach==1.5.0', 'click==6.7',
	                  ...
	                  'html5lib==0.9999999', 'itsdangerous==0.24', 'Jinja2==2.10', 'Keras==2.2.1',
	                  'kiwisolver==1.0.1', 'Markdown==2.6.11', 'MarkupSafe==1.0', 'matplotlib==2.0.3', 'nose==1.3.7', 'numpy==1.17.0',
	                  'pandas==0.24.2', 'protobuf==3.6.1', 'pyparsing==2.2.0', 'python-dateutil==2.7.3', 'pytz==2018.5', 'python-Levenshtein',
	                  'PyYAML==3.13', 'scikit-learn==0.22.0', 'scipy==1.3.1', 'six==1.11.0',
